...
If you experience bugs or general issues with ``check-python-h-first``, please have a look
...
You can help improve ``check-python-h-first`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``check-python-h-first`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``check-python-h-first``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n check-python-h-first python=3 six virtualenv pytest pytest-cov
    conda activate check-python-h-first
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/check-python-h-first.git
...
#. Install |pre-commit|_::
   ...
   ``check-python-h-first`` comes with a lot of hooks configured to automatically help the
